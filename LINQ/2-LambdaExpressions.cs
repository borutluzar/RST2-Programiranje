...
namespace LINQ
{
    ...
    class LambdaExpressions
    {
        public static void LambdaTests()
        {
            ...
            // Preden si ogledamo razlike med njima, ponovimo, kaj so to lambda-izrazi.
            ...
            Console.WriteLine($"Zaokrožimo število 4.5: {roundUp(4.5)}");
            Console.WriteLine($"Zaokrožimo število 4.5: {roundDown(4.5)}");
            Console.WriteLine($"Zaokrožimo število 4.5001: {roundUp(4.5001)}");
            Console.WriteLine($"Zaokrožimo število 4.5001: {roundDown(4.5001)}");
            ...
            // kjer delamo poizvedbo. Za druga dva načina se podatki najprej prenesejo
